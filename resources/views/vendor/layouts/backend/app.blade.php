                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="{{ route('parametre.index') }}"><i class="material-icons">person</i>Profil</a></li>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    @if (Request::is('admin*'))
                        ...
                        <li class="{{Request::is('admin/abonnements*')?'active':''}}">
                        ...
                        <li class="{{Request::is('admin/blogueurs*')?'active':''}}">
...
<!-- 
                    ...
                    @if (Request::is('blogger*'))
                        <li class="{{Request::is('blogger/dashboard')?'active':''}}">
                        ...
                        <li class="{{Request::is('blogger/posts*')?'active':''}}">
                        ...
                        <li class="{{Request::is('blogger.favorite')?'active':''}}">
                        ...
                        <li class="{{Request::is('blogger/pending/posts')?'active':''}}">
                    ...
                    <li class="{{Request::is('parametre')?'active':''}}">
